    ...
    return (
        <div className="bg-white shadow-xl rounded-2xl p-6 max-w-3xl mx-auto border border-gray-200 mt-10">
            ...
            <div className="flex flex-col items-center space-y-6">
                ...
                <button
                    onClick={() =>window.open("https://youtube.com/@spiritiitbhu?si=hBpxXQi2Or3f5Rul", "_blank")}
...
//Form Link:- https://forms.gle/uHcFQC35A5wfYwkT6 
// TODO: Add form link in button above
