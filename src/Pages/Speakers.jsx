...
const Speakers = () => {
  const speakers = [
    {
      name: "Karun Gaur",
      image: "./speakers/karun_gaur.jpg",
      des: "Vice President",
      company: "Dr. Reddy's Laboratories",
      logo: "./speakers/dr_reddy_lab.png",
    },
    {
      name: "Dr. Sadanand Kulkarni",
      image: "./speakers/sadanand_kulkarni.jpg",
      des: "Head-Medical, Regulatory, Quality, Vigilance",
      company: "Fresenius Kabi South Asia",
      logo: "./speakers/fresenius_kabi.png",

    },
    {
      name: "Avinash Narwaria",
      image: "./speakers/avinash_narwaria.jpg",
      des: "Ex-VP",
      company: "Emami",
      logo: "./speakers/emami.png",
    },
    {
      name: "Dr. Rajiv Desai",
      image: "./speakers/rajiv_desai.jpg",
      des: "Senior Technical Advisor",
      company: "IPA",
      logo: "./speakers/ipa.png",
    },
    {
      name: "Dr. Saurabh Kumar",
      image: "./speakers/saurabh_kumar.jpeg",
      des: "Principal & Head RWE",
      company: "IQVIA",
      logo: "./speakers/iqvia_logo.jpeg",
    },
    {
      name: "Dr. Anand Agarwal",
      image: "./speakers/anand_agarwal.jpg",
      des: "Senior Vice President",
      company: "Cipla",
      logo: "./speakers/cipla_logo.jpeg",
    },
    {
      name: "Dr. P. A. Sivakumar",
      image: "./speakers/dr_pa_sivakumar.jpg",
      des: "Vice President",
      company: "Biological E. Limited",
      logo: "./speakers/biological_e_logo.jpeg",
    },
    {
      name: " Nitesh Kumar",
      image: "./speakers/nitesh_kumar.jpg",
      des: "Co-Founder",
      company: "Leumas",
      logo: "./speakers/leumasware_logo.jpeg",
    },
    {
